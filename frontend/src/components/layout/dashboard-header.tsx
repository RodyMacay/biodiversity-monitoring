            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs text-gray-500">
                    3 registros requieren verificación de un administrador
                  </p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium">Alerta de conservación</p>
                  <p className="text-xs text-gray-500">
                    Disminución del 15% en observaciones de Quetzal este mes
                  </p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
